...
{B2}╭──────────────────────╮{B2}╭───────────────╮{B2}╭────────────────────────────╮
{B2}│ {P2}Author : Adil {B2}│{B2}│ {P2}Version : 2.1 {B2}│{B2}│ {P2}Recode By : Adil Aja{B2}       │
...
class Menu:
	...
	def menu(self):
		...
		cetak(Panel(f"{H2}Sunshine ID, Adil aja ID, Adil",width=87,title=f"{H2}Thanks To",style=f"{color_panel}"))
