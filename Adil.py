...
for xcTeam in range(1000):
	...
	ngentot4 = f"Mozilla/5.0 (Linux; Android 8; Infinix NOTE 2 LTE Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/101.0.4951.54 Mobile Safari/537.36"
	if ngentot4 in ngentott:pass
	else:ngentott.append(ngentot4)
	ngentot5 = f"Mozilla/5.0 (Linux; Android 6; Infinix NOTE 2 LTE Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/101.0.4951.54 Mobile Safari/537.36"
	if ngentot5 in ngentott:pass
	else:ngentott.append(ngentot4)
	ngentot6 = f"Mozilla/5.0 (Linux; Android 9; Infinix NOTE 2 LTE Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/101.0.4951.54 Mobile Safari/537.36"
	if ngentot6 in ngentott:pass
	else:ngentott.append(ngentot4)
	ngentot4 = f"Mozilla/5.0 (Linux; Android 13; Infinix NOTE 2 LTE Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/101.0.4951.54 Mobile Safari/537.36"
