...
for z in range(200):
	...
	ua_v = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36]"
	ua_o =f"Mozilla/5.0 (iPhone; CPU iPhone OS 12_5_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16H81 [FBAN/FBIOS;FBDV/iPhone6,1;FBMD/iPhone;FBSN/iOS;FBSV/12.5.7;FBSS/2;FBID/phone;FBLC/es_LA;FBOP/5]"
	ua_s = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-X906C Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36]"
	ua_v =f"Mozilla/5.0 (Linux; Android {ver_and}; XIAOMI Redmi Note 9 Pro Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.111 Mobile Safari/537.36 AlohaBrowser/2.19.3]"
	...
	ua_o =f"Mozilla/5.0 (Linux; Android {ver_and}; Redmi 5 Plus Build/OPM1.171019.019) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36]"
	...
	ua_s =f"viabrowser;Safary-Mozilla/5.0 (Windows NT 10.0 .{str(rr(1,20))}; WOW64){str(rc(gt))})Applewebkit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,140))}.0.{str(rr(3990,5001))}.{str(rr(20,170))} Safari/537.36 Vivaldi/6.0.2979.18]"
	ua_a = f"Mozilla/5.0 (Linux; Android {ver_and}; V2068; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 VivoBrowser/9.0.3.0]"
	ua_n =f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G925F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/170.0.0.52.95]"
	ua_s = f"Mozilla/5.0 (Linux; Android {ver_and}; V2249; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 VivoBrowser/11.4.0.1]"
	ua_n =f"Mozilla/5.0 (Linux; Android {ver_and}; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36]"
	ua_a = f"Mozilla/5.0 (Linux; U; Android {ver_and}; en-gb; CPH1859 Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 OppoBrowser/15.5.0.9]"
	ua = str(rc([ua_d,ua_s]))
