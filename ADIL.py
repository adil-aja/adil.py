...
for z in range(200):
	...
	ua_i = f"Mozilla/5.0 (Linux; Android 9; Redmi Note 5 Build/PKQ1.180904.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36 bdbrowser/6.4.0.4]"
	ua_s = f"Mozilla/5.0 (Linux; Android 8.1.0; Redmi Note 5 Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36 baidubrowser/7.18.11.0 (Baidu; P1 8.1.0)]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; ELE-L04; HMSCore 6.6.0.352; GMSCore 22.26.15) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} HuaweiBrowser/12.1.1.324]"
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-J250F Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/288.0.0.15.118]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G770F Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/407.0.0.30.97]"
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36]"
	...
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-X906C Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; XIAOMI Redmi Note 9 Pro Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.111 Mobile Safari/537.36 AlohaBrowser/2.19.3]"
	ua_i = f"Mozilla/5.0 (Linux; U; Android {ver_and}; zh-CN; Redmi Note 8 Pro Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} UCBrowser/{str(rr(10,90))}.{str(rr(1,9))}.{str(rr(1,9))}.{str(rr(1000,1900))} Mobile Safari/537.36]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; Redmi 5 Plus Build/OPM1.171019.019) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36]"
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; vivo 1902) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36 OPR/61.2.3076.56749]"
	ua_i =f"viabrowser;Safary-Mozilla/5.0 (Windows NT 10.0 .{str(rr(1,20))}; WOW64){str(rc(gt))})Applewebkit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,140))}.0.{str(rr(3990,5001))}.{str(rr(20,170))} Safari/537.36 Vivaldi/6.0.2979.18]"
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; V2068; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 VivoBrowser/9.0.3.0]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G925F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/170.0.0.52.95]"
	ua_i = f"Mozilla/5.0 (Linux; Android {ver_and}; V2249; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 VivoBrowser/11.4.0.1]"
	ua_i =f"Mozilla/5.0 (Linux; Android {ver_and}; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36]"
	ua_i = f"Mozilla/5.0 (Linux; U; Android {ver_and}; en-gb; CPH1859 Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 OppoBrowser/15.5.0.9]"
	ua = str(rc([ua_d,ua_s]))
